...
This project includes two AI implementations (basic Minimax and Minimax with Alpha-Beta pruning), supports Human vs AI and AI vs AI modes, and lets you set an initial board position for testing. The main implementation is in `Gomoku.py`. :contentReference[oaicite:1]{index=0}
